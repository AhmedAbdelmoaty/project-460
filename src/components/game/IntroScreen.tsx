        ...
        <Card className="bg-muted/50">
          <CardContent className="p-4">
            <div className="text-sm text-muted-foreground text-center space-y-1">
              <p>💡 عندك 4 خطوات تحقيق فقط لاكتشاف المؤشرات.</p>
              <p>✅ تقدر تعلن القرار في أي وقت (حتى لو الخطوات خلصت).</p>
              <p>🧠 ولو مش قادر تحسم، تقدر تضغط "إنهاء التحقيق" (وتتحسب بدون قرار).</p>
            </div>
          </CardContent>
        </Card>
